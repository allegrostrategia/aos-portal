...
2. **"AI drafts, human confirms" is the pattern for anything AI-touched.** Hot seat prep, SOP generation, roadmap re-pointing, the roadmap reveal document — Claude drafts, Nina reviews and confirms, never full automation without a human checkpoint.
