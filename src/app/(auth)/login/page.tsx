...
export default async function LoginPage({ searchParams }: PageProps<"/login">) {
  ...
  return (
    <>
      <h1 className="font-display mb-1 text-title font-medium text-ink">Bentornato</h1>
      ...
      <p className="mt-5 text-center text-small text-ink/70">
        <Link
          href="/forgot-password"
          className="underline decoration-orange decoration-2 underline-offset-4 hover:text-ink"
        >
      ...
      <p className="mt-6 border-t border-ink/10 pt-5 text-center text-caption text-ink/60">
