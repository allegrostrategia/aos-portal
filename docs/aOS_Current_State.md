...
- **The member directory (§10).** `member_profiles` exists and members fill theirs in during onboarding, but there's no browse or search screen and no "chat" button through to a DM. `/sociale` names it as still to come rather than leaving a hole.
